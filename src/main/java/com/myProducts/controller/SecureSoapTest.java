...
import org.jboss.quickstarts.fuse.soap.secure.HelloWorld;
...
public class SecureSoapTest{
    ...
    public void sendRequest() throws Exception {
        ...
        factory.setAddress("http://localhost:8182/cxf/HelloWorldSecurity");
        
        factory.getInInterceptors().add(new LoggingInInterceptor());
        factory.getOutInterceptors().add(new LoggingOutInterceptor());
        
        factory.getHandlers().add(new SecurityHandler());
        
        HelloWorld client = (HelloWorld) factory.create();
        client.sayHi("Interacciones");
    }
    
    @Test
    public void sendRequestMyr() throws Exception {
        /*
         * Set up the JaxWsFactoryBean to access our client:
         * - the Java interface defining the service
         * - the HTTP address for the service
